...
public class SpringModel {
    ...
    public static final double SPRING_A = 1.;
    public static final double SPRING_GAMMA = 100.;
    public static final double PARTICLE_MASS = 70.;
    ...
    public SpringModel(final IntegralSolver integralSolver) {
        ...
        double rx2 = (-SPRING_K * rx - SPRING_GAMMA * rx1) / PARTICLE_MASS;
        ...
        this.particle = new Particle(1,
                ...
                PARTICLE_MASS,
                PARTICLE_RADIUS);
        System.out.printf("rx: %f rx1: %f rx2: %f%n", rx, rx1, rx2);
    }
    ...
    public void run(double dt, double dt2) {
        ...
        try (CSVWriter writer = new CSVWriter(new FileWriter(path))) {
            System.out.printf("Running on solver %s with dt: %e%n", integralSolver.toString(), dt);
